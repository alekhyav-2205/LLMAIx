...
if __name__ == "__main__":
    ...
    if not os.path.isfile(app.config["SERVER_PATH"]) and not args.only_api:
        print("INFO: Skipping llama.cpp server — using local Python llama-cpp backend.")
    ...
    socketio.run(app, debug=True, use_reloader=True, port=args.port, host=args.host, allow_unsafe_werkzeug=True)
